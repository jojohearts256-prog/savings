...
export default function GuarantorApprovalModal({
  ...
  const handleDecision = async (decision: 'accept' | 'decline') => {
    try {
      ...
      // ================= BACKGROUND LOGIC =================
      // Notify borrower for this guarantor's response
      sendNotification({
      ...
      // ✅ If all guarantors approved → notify admin & borrower
      const allApproved =
