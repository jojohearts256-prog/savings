              ...
              notifications.map((n) => (
                <div
                  ...
                  className={`p-2 rounded-xl mb-2 ${
                    n.read ? 'bg-gray-700' : 'bg-orange-500'
                  }`}
                >
            ...
            {transactions.length === 0 ? (
              ...
              <ul className="space-y-3">
                {transactions.map((t) => (
                  <li
                    key={t.id}
                    className="flex justify-between items-center bg-gray-50 p-3 rounded-xl shadow border hover:shadow-md transition"
                  >
                    <div>
                    ...
                    <span
                      className={`font-semibold ${
                        t.type === 'credit' ? 'text-green-500' : 'text-orange-500'
                      }`}
                    >
            ...
            {loans.length === 0 ? (
              ...
              <ul className="space-y-3">
                {loans.map((l) => (
                  <li
                    key={l.id}
                    className="bg-gray-50 p-3 rounded-xl shadow border flex justify-between items-center hover:shadow-md transition"
                  >
                    <div>
