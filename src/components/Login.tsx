...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-[#00BFFF] via-[#008080] to-[#FF6F91] overflow-hidden">
      {/* Left side: Login Form */}
      <div className="w-full md:w-1/2 flex items-center justify-center px-6 relative z-10">
        <div className="p-10 w-full max-w-md rounded-2xl shadow-2xl bg-white/10 backdrop-blur-lg animate-slide-in border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-100/90">Your Trusted Partner in Smart Savings</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-[#00BFFF] to-[#FF6F91] text-white font-semibold rounded-xl shadow-md hover:scale-105 transition-transform duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      {/* Right side (visual extension of gradient, no separation line) */}
      <div className="hidden md:flex w-1/2 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-[#008080]/60 to-white"></div>

        {/* Floating creative text */}
        ...
        {/* Floating circles */}
        <div className="absolute -top-24 -left-24 w-80 h-80 bg-white/15 opacity-20 rounded-full animate-spin-slow"></div>
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-white/15 opacity-20 rounded-full animate-spin-slow-reverse"></div>
      </div>
